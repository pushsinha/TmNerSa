...
-After cleaning, ‘TmNerSa/code/Ner/nltk/ner.py’ can be used to tag the words in the cleaned data. On articles it takes ~2 days and on comments its has not been checked.
